...
class TDOBBKpt1DFLCriterion(nn.Module):
    """Loss for DFL‑based OBB + keypoint detection.
    ...
    Args:
        ...
        neighbor_range: Manhattan distance around the centre cell for positive samples.
